...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    echo "    -sd folder              - Set the MATLAB startup folder to folder,"
    echo "                              specified as a string."
...
#
        if [ "$debugger" != "" ]; then
            if [ "$MATLAB_DEBUG" = "gdb" -o "$MATLAB_DEBUG" = "xxgdb" \
                -o "$MATLAB_DEBUG" = "undodb-gdb" -o "$MATLAB_DEBUG" = "ddd" ]; then
